...
|---|---|---|---|
| Central K3 orchestrator | task graph, checkpoint/state, final integration | `app/manager.py`, `app/providers.py`, merged main `be5c6a3` | K3 compatibility implementation merged; front-door follow-up in review |
